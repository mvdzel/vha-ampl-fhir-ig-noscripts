...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest/f:dosageInstruction/f:timing/f:repeat">
      ...
      <sch:assert test="not(exists(f:timeOfDay)) or not(exists(f:when))">If there's a timeOfDay, there cannot be be a when, or vice versa (inherited)</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationRequest/f:dosageInstruction/f:dose[x] 1</sch:title>
