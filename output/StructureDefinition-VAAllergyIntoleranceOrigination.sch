...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Provenance/f:location</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Provenance/f:location/f:identifier</sch:title>
    <sch:rule context="f:Provenance/f:location/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
